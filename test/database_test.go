...
func TestMerchantCRUD(t *testing.T) {
	...
	// 讀取
	var readMerchant entity.Merchant
	...
	// 驗證更新
	var updatedMerchant entity.Merchant
	...
	// 驗證軟刪除
	var deletedMerchant entity.Merchant
...
func TestManagerCRUD(t *testing.T) {
	...
	// 讀取
	var readManager entity.Manager
